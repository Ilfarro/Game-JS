...
function correctAnswer3() {
    ...
    backgroundMusic.setAttribute('src', 'applause.wav');
    setInterval(backgroundMusic, 1000);
    alert("Mata Pancingg!! (prepare your keyboard please..)")
    backgroundMusic.setAttribute('src', 'background.mp3');
    soal4()
}
...
function correctAnswer5() {
    ...
    backgroundMusic.setAttribute('src', 'applause.wav');
    setInterval(backgroundMusic, 1000);
    alert("Selamat akhirnya anda bisa keluar dari lingkaran setan...")
    restart();
}
...
function wrongAnswer () {
    if (death == 0) {
        ...
        backgroundMusic.removeAttribute('loop');
        backgroundMusic.setAttribute('src', 'Glass-breaking-sound.mp3');
        setInterval(backgroundMusic, 3000);
        alert('Maaf anda kurang benar :p')
        backgroundMusic.setAttribute('src', 'background.mp3');
        death = death + 1
    } else if (death == 1) {
        ...
        backgroundMusic.setAttribute('src', 'Glass-breaking-sound.mp3');
        setInterval(backgroundMusic, 3000);
        alert('Maaf anda kurang benar LAGI :p')
        backgroundMusic.setAttribute('src', 'background.mp3');
        death = death + 1
    } else if (death == 2) {
